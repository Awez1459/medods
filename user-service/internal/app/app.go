...
import (
	...
	grpc_server "medods/user-service/internal/delivery/grpc/server"
	invest_grpc "medods/user-service/internal/delivery/grpc/services"
	"medods/user-service/internal/infrastructure/grpc_service_clients"
	repo "medods/user-service/internal/infrastructure/repository/postgresql"
	"medods/user-service/internal/pkg/config"
	"medods/user-service/internal/pkg/logger"
